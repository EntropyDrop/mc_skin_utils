...
mc_skin_utils_render skin.png --interact --light
```

**Save to File:**
```bash
# Save a 600x600 screenshot to output.png
mc_skin_utils_render skin.png --save output.png --output-size 600 600
```
...
### 3. mc_skin_utils_ensure_skin64x64
...
mc_skin_utils_ensure_skin64x64 legacy_skin.png

# Specify a custom output path
mc_skin_utils_ensure_skin64x64 legacy_skin.png -o modern_skin.png
```
